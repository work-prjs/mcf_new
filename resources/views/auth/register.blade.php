...
<div class="register-box">
    <div class="register-logo">
        <a href="{{ url('/home') }}"><b>Вход </b>в систему</a>
    </div>

    <div class="register-box-body">
        <p class="login-box-msg">Регистрация нового участника</p>
            ...
            <div class="row">
                <div class="col-xs-6">
                    <div class="checkbox icheck">
                        <label>
                            <input type="checkbox"> Принимаю <a href="#">условия</a>
                        </label>
                    </div>
                </div>
                <!-- /.col -->
        ...
        <a href="{{ url('/login') }}" class="text-center">Вход в систему</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
